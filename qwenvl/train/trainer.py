...
# Flash Attention disabled due to GLIBC compatibility issues
...
def replace_qwen2_vl_attention_class():
    # Flash Attention replacement disabled due to GLIBC compatibility issues
    # Using PyTorch native SDPA attention instead
    print("Flash Attention replacement disabled - using PyTorch native SDPA attention")
    pass
